import { z } from 'zod';
import { insertUserSchema, insertAttendanceSchema, insertAnnouncementSchema, insertLeaveRequestSchema, users, attendance, announcements, leaveRequests } from './schema.js';
